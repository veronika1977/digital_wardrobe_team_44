...
1. Expand frontend automated testing — Add React Testing Library + MSW tests for Weather and Calendar UI states; target 50% frontend coverage by Sprint 4.
...
3. Enforce cross-repo API contract validation — Add OpenAPI schema diff check to CI; block PRs if backend endpoint changes break frontend types.
   - Related docs: [`docs/development-process.md`](../../docs/development-process.md), [Backend CI](https://github.com/Mrxfg/digital-wardrobe/actions)
...
4. Instrument production metrics for QR validation — Add response time logging and error rate monitoring for Weather/Calendar endpoints to validate QR-001/002 under real traffic.
   - Related docs: [`docs/quality-requirements.md`](../../docs/quality-requirements.md)                                            *Related artifacts:*  
[Sprint Review Summary](./sprint-review-summary.md) | [Retrospective](./retrospective.md)
