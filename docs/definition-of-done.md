...
- API documentation (`docs/API Documentation.md`) is updated if endpoints changed.
- Design system documentation (`docs/design-system.md`) is updated if UI components changed.
- Relevant architecture documentation (`docs/architecture/`, ADRs) is updated or explicitly documented as not applicable.
